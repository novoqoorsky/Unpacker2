...
class draw_wave : public TSelector {
public :
 ...
 //Event           *event;
   ...
   ClassDef(draw_wave,0);
};

#endif

#ifdef draw_wave_cxx
void draw_wave::Init(TTree *tree)
{
