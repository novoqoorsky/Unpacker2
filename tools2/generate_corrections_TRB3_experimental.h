...
#ifndef generate_corrections_TRB3_experimental_h
#define generate_corrections_TRB3_experimental_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxTDCHits = 47;
   const Int_t kMaxADCHits = 1;

class generate_corrections_TRB3_experimental : public TSelector {
public :
 ...
 //Event           *event;
   ...
   generate_corrections_TRB3_experimental(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~generate_corrections_TRB3_experimental() { }
   ...
   ClassDef(generate_corrections_TRB3_experimental,0);
};

#endif

#ifdef generate_corrections_TRB3_experimental_cxx
void generate_corrections_TRB3_experimental::Init(TTree *tree)
{
...
Bool_t generate_corrections_TRB3_experimental::Notify()
{
...
#endif // #ifdef generate_corrections_TRB3_experimental_cxx
