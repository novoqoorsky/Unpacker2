...
// Thu Feb  5 16:27:04 2015 by ROOT version 5.34/14
// from TTree T/Tree
// found on file: /home/pandastraws/hldFiles/xx15036144443.hld.root
//////////////////////////////////////////////////////////

#ifndef analyze_with_epochs_h
#define analyze_with_epochs_h
...
const Int_t kMaxTDCHits = 1600;
const Int_t kMaxADCHits = 1;

class analyze_with_epochs : public TSelector {
public :
 ...
 //Event           *event;
   ...
   analyze_with_epochs(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analyze_with_epochs() { }
   ...
   ClassDef(analyze_with_epochs,0);
};

#endif

#ifdef analyze_with_epochs_cxx
void analyze_with_epochs::Init(TTree *tree)
{
...
Bool_t analyze_with_epochs::Notify()
{
...
#endif // #ifdef analyze_with_epochs_cxx
