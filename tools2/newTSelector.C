#define newTSelector_cxx
// The class definition in newTSelector.h has been generated automatically
...
//
// Root > T->Process("newTSelector.C")
// Root > T->Process("newTSelector.C","some options")
// Root > T->Process("newTSelector.C+")
//

#include "./newTSelector.h"
...
Int_t   Channels[8] = {   1 ,	// #0    Channel switch 0=off  1=on  
			  ...
			  1 ,	// #6
			  1 };  // #7  
 Int_t EntryMax = 46000, sumRangeMin = 300, sumRangeMax = 8000, sumBinWidth =20;
 Int_t timeDiffRangeMin = 20, timeDiffRangeMax = 2700;
 Int_t totRangeMin = 0, totRangeMax = 1200;
...
Int_t   Channels[8] = {   1 ,	// #0    Channel switch 0=off  1=on  
			  ...
			  1 ,	// #6
			  1 };  // #7  
 Int_t EntryMax = 45000, sumRangeMin = 600, sumRangeMax = 900, sumBinWidth =10;
 Int_t timeDiffRangeMin = 500, timeDiffRangeMax = 600;
 Int_t totRangeMin = 150, totRangeMax = 200;
else {
...
Int_t   Channels[8] = {   1 ,	// #0    Channel switch 0=off  1=on  
 ...
 Int_t EntryMax = 40000, sumRangeMin = 0, sumRangeMax = 5000, sumBinWidth =30;
 Int_t timeDiffRangeMin = 500, timeDiffRangeMax = 2200;
 Int_t totRangeMin = 0, totRangeMax = 1200;
//} 
...
//THStack *hsADC = new THStack("hsADC","Stacked ADC histograms");


void newTSelector::Begin(TTree * /*tree*/)
{
...
void newTSelector::SlaveBegin(TTree * /*tree*/)
{
...
//    	hADC = new TH1F(buf1,buf2,128,0,128);
 ...
 */
   ...
   //cout<<"definice grafu"<<endl; 

}

Bool_t newTSelector::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either newTSelector::GetEntry() or TBranch::GetEntry()
  ...
  //printf("entry %d\n",entry);
	...
	b_event_ADCHits_->GetEntry(entry);
...
void newTSelector::SlaveTerminate()
{
...
void newTSelector::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.

//  TString filename = gROOT->GetListOfFiles()->Last()->GetName();
