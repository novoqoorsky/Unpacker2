#define draw_wave_cxx
// The class definition in draw_wave.h has been generated automatically
...
//
// Root > T->Process("draw_wave.C")
// Root > T->Process("draw_wave.C","some options")
// Root > T->Process("draw_wave.C+")
//
...
void draw_wave::Begin(TTree * /*tree*/)
{
...
void draw_wave::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t draw_wave::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either draw_wave::GetEntry() or TBranch::GetEntry()
